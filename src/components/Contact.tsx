...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/GjergjBrestovci',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/gjergjbrestovci',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/GjergjBrestovci',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:gjergj.brestovci@gmail.com',
      icon: (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="gjergj.brestovci@gmail.com" className="text-accent hover:text-accent-hover">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((link) => (
                  <motion.a
                    ...
                    className="p-3 bg-background-subtle rounded-lg border border-border-light hover:bg-accent hover:text-white transition-colors"
